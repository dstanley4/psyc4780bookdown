...
Check out Mine Çetinkaya-Rundel's video [Get started with Quarto](https://www.youtube.com/watch?v=_f3latmOhew).

Also see [Create & Publish a Quarto Blog on Quarto Pub in 100 Seconds](https://www.youtube.com/watch?v=t8qtcDyCRFA).

You might also want to check a package for [Quarto APA 7 papers](https://github.com/wjschne/apaquarto).
