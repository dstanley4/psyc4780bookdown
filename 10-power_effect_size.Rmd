...
## Sequential Analysis and Optional Stopping
...
Another approach to determine the effect size to use in your independent groups $t$-test power / sample size analysis is to determine the smallest effect that would have been significant in the previous study [@lakens2018equivalence]. We do that with the code below:
